<template>
  <TransitionRoot as="template" :show="state.clinics_slide_over.open == true && !!state.clinics_slide_over.clinic_form">
    <Dialog as="div" static class="fixed inset-0 overflow-hidden" @close="state.clinics_slide_over.open = false"
      :open="state.clinics_slide_over.open == true">
                  ...
                  <div class="flex items-start justify-between">
                    ...
                    <div class="ml-3 h-7 flex items-center">
                      <button
                        ...
                        @click="state.clinics_slide_over.open = false">
                    ...
                    <div class="mt-12 flow-root px-4 sm:-mt-8 sm:flex sm:items-end sm:px-6 lg:-mt-15">
                      <div class="mt-12 sm:ml-6 sm:flex-1">
                        <div>
                          <div class="flex items-center">
                            <h3 class="font-bold text-xl text-appromed sm:text-2xl">
                              {{ state.clinics_slide_over.clinic_form.name }}</h3>
                          </div>
                          <p class="text-sm text-appromed">{{ state.clinics_slide_over.clinic_form.email }} /
                            +{{ state.clinics_slide_over.clinic_form.phone }}</p>
                        </div>
                        <div class="mt-5 flex flex-wrap space-y-3 sm:space-y-0 sm:space-x-3">
                          <router-link :to="'mailto:' + state.clinics_slide_over.clinic_form.email"
                          ...
                          <router-link :to="'tel:+' + state.clinics_slide_over.clinic_form.phone"
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.name" required type="text"
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.partnership" required type="text"
                        ...
                        <div class="col-span-2 my-3 lg:col-span-full">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.address" required
                        ...
                        <div class="col-span-2 my-3 lg:col-span-1">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.beds" required id="clinic_form.beds"
                        ...
                        <div class="col-span-2 my-3 lg:col-span-1">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.patients" required
                              id="clinic_form.patients" name="clinic_form.patients" type="number"
                              autocomplete="clinic_form.patients"
                              class="py-3 px-4 block w-full shadow-sm text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                          </div>
                        </div>
                        ...
                        <div class="col-span-2 my-3 lg:col-span-1">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.employees" required
                              id="clinic_form.employees" name="clinic_form.employees" type="number"
                              autocomplete="clinic_form.employees"
                              class="py-3 px-4 block w-full shadow-sm text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                          </div>
                        </div>
                        ...
                        <div class="col-span-2 my-3 lg:col-span-1">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.education" required
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.leader" required
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.email" required name="clinic_form.email"
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.website" required
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form.phone" required name="clinic_form.phone"
                        ...
                        <div class="col-span-full my-3">
                          ...
                          <div class="mt-1">
                            <textarea v-model="state.clinics_slide_over.clinic_form.about" id="about"
                        ...
                        <div class="my-3 max-w-1/2">
                          ...
                          <Combobox @change="(v) => state.clinics_slide_over.clinic_form.specializations.push(v)"
                            :show_3_suggestions="false" :multiple="true" placeholder="Search Specializations..."
                            :options="specializations" />
                          <EditableTable :rows="state.clinics_slide_over.clinic_form.specializations" :fields="['name']"
                            :headers="['Name']" />
                        </div>
                        ...
                        <div class="col-span-full" v-for="p in preferences">
                          ...
                          <Stars :name="p.name" :max="5" :modelValue="state.clinics_slide_over.clinic_form[p.field]" />
                        </div>
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form['username']" required
                        ...
                        <div class="col-span-2 my-3">
                          ...
                          <div class="mt-1">
                            <input v-model="state.clinics_slide_over.clinic_form['password']" required
                        ...
                        <button type="button" @click="update_clinic()"
...
import { XCircleIcon, CheckIcon, EnvelopeIcon, PhoneIcon } from '@heroicons/vue/24/outline'

import { t } from '~/i18n'
import { state } from '@/store/global'
import { fireAPI } from '@/hooks/fireAPI'

const update_clinic = async () => {
  const [clinic, err] = await fireAPI('/api/v2/medching/admin/clinics/update', state.clinics_slide_over.clinic_form, false)
