...
<template>
  <div class="contents">
    <div class="w-full">
      <div class="h-full flex flex-col bg-white overflow-y-scroll w-full">
              ...
              <div class="mt-12 sm:ml-6 sm:flex-1">
                <div>
                  <div class="flex items-center">
                    <h3 class="font-bold text-xl text-appromed sm:text-2xl">{{ state.user_clinic.name }}</h3>
                  </div>
                  <p class="text-sm text-appromed">{{ state.user_clinic.email }} / +{{ state.user_clinic.phone }}</p>
                </div>

                <div class="col-span-2 my-3">
                  <label for="clinic_form.name" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_31') }}</label>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.name" required type="text" name="clinic_form.name" id="clinic_form.name" autocomplete="clinic_form.name" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                  </div>
                </div>

                <div class="col-span-2 my-3">
                  <label for="clinic_form.partnership" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_32') }}</label>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.partnership" required type="text" name="clinic_form.partnership" id="clinic_form.partnership" autocomplete="family-name" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                  </div>
                </div>

                <div class="col-span-2 my-3 lg:col-span-full">
                  <div class="flex justify-between">
                    <label for="clinic_form.address" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_33') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.address" required id="clinic_form.address" name="clinic_form.address" type="text" autocomplete="clinic_form.address" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                  </div>
                </div>

                <div class="col-span-2 my-3 lg:col-span-1">
                  <div class="flex justify-between">
                    <label for="clinic_form.beds" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_40') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.beds" required id="clinic_form.beds" name="clinic_form.beds" type="number" autocomplete="clinic_form.beds" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                  </div>
                </div>

                <div class="col-span-2 my-3 lg:col-span-1">
                  <div class="flex justify-between">
                    <label for="clinic_form.patients" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_41') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.patients" required id="clinic_form.patients" name="clinic_form.patients" type="number" autocomplete="clinic_form.patients" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                  </div>
                </div>

                <div class="col-span-2 my-3 lg:col-span-1">
                  <div class="flex justify-between">
                    <label for="clinic_form.employees" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_42') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.employees" required id="clinic_form.employees" name="clinic_form.employees" type="number" autocomplete="clinic_form.employees" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                  </div>
                </div>

                <div class="col-span-2 my-3 lg:col-span-1">
                  <div class="flex justify-between">
                    <label for="clinic_form.education" class="block text-sm font-medium text-appromed-dark dark:text-appromed">Weiterbildungsermächtigung</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.education" required id="clinic_form.education" name="clinic_form.education" type="text" autocomplete="clinic_form.education" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" />
                  </div>
                </div>

                <div class="col-span-2 my-3">
                  <div class="flex justify-between">
                    <label for="clinic_form.leader" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_35') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.leader" required name="clinic_form.leader" id="clinic_form.leader" type="text" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" aria-describedby="phone-optional" />
                  </div>
                </div>

                <div class="col-span-2 my-3">
                  <div class="flex justify-between">
                    <label for="clinic_form.email" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_39') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.email" required name="clinic_form.email" id="clinic_form.email" type="email" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" aria-describedby="phone-optional" />
                  </div>
                </div>

                <div class="col-span-2 my-3">
                  <div class="flex justify-between">
                    <label for="clinic_form.website" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_37') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.website" required name="clinic_form.website" id="clinic_form.website" type="text" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" aria-describedby="phone-optional" />
                  </div>
                </div>

                <div class="col-span-2 my-3">
                  <div class="flex justify-between">
                    <label for="clinic_form.phone" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_38') }}</label>
                  </div>
                  <div class="mt-1">
                    <input v-model="state.user_clinic.phone" required name="clinic_form.phone" id="clinic_form.phone" type="number" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border-appromed rounded-md" aria-describedby="phone-optional" />
                  </div>
                </div>

                <div class="col-span-full my-3">
                  <div class="flex justify-between">
                    <label for="clinic_form.about" class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_44') }}</label>
                  </div>
                  <div class="mt-1">
                    <textarea v-model="state.user_clinic.about" id="about" placeholder="Infos zur Lage (Standort, Region), Betriebskita/ Kindergarten in der Nähe, Verkehrsanbindung, Kurzbeschreibung der Klinik, Firmenphilosophie etc." name="message" rows="4" class="py-3 px-4 block w-full text-appromed-dark focus:ring-appromed focus:border-appromed border border-appromed rounded-md" aria-describedby="message-max" />
                  </div>
                </div>


                <div class="my-3 max-w-1/2">
                  <label class="block text-sm font-medium text-appromed-dark dark:text-appromed">{{ t('_13') }}</label>
                  <Combobox @change="(v) => state.user_clinic.specializations.push(v)" :show_3_suggestions="false" :multiple="true" placeholder="Search Specializations..." :options="specializations" />
                  <EditableTable :rows="state.user_clinic.specializations" :fields="['name']" :headers="['Name']" />
                </div>
              </div>
            </div>
          </div>
